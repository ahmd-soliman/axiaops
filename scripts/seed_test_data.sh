...
VALUES
  ...
  ('${TENANT_ID}', 'aws', 'dev-account-001', 'dev-account-001', 'AmazonEC2', 'eu-central-1',
  ...
  ('${TENANT_ID}', 'aws', 'dev-account-001', 'dev-account-001', 'AmazonRDS', 'eu-central-1',
  ...
  ('${TENANT_ID}', 'aws', 'dev-account-001', 'dev-account-001', 'AmazonElasticLoadBalancing', 'eu-central-1',
  ...
  ('${TENANT_ID}', 'aws', 'dev-account-001', 'dev-account-001', 'AmazonVPC', 'eu-central-1',
   'eipalloc-prod00001', '{}',
  ...
  ('${TENANT_ID}', 'aws', 'dev-account-002', 'dev-account-002', 'AmazonEC2', 'us-east-1',
  ...
  ('${TENANT_ID}', 'aws', 'dev-account-002', 'dev-account-002', 'AWSLambda', 'us-east-1',
   'stg-image-resizer', '{\"env\":\"staging\",\"team\":\"backend\"}',
   4.10, 'USD', '$PERIOD_START', '$PERIOD_END',
   'Invocations', 0, 'Count',
   'Zero invocations — likely unused', 'backend', '$NOW'),

  ('${TENANT_ID}', 'aws', 'dev-account-002', 'dev-account-002', 'AmazonVPC', 'us-east-1',
   'eipalloc-stg00001', '{}',
   3.60, 'USD', '$PERIOD_START', '$PERIOD_END',
   'NetworkInterfaceAttachment', 0, 'Count',
   'Elastic IP not attached to any resource — incurring \$0.005/hour idle charge', 'unknown', '$NOW'),
  ...
  ('${TENANT_ID}', 'aws', 'dev-account-003', 'dev-account-003', 'AmazonEC2', 'eu-west-1',
   'i-0abc123dev0001', '{\"env\":\"dev\",\"team\":\"backend\"}',
   22.80, 'USD', '$PERIOD_START', '$PERIOD_END',
   'CPUUtilization', 0.3, 'Percent',
   'Instance CPU below 5% — likely idle', 'backend', '$NOW'),

  ('${TENANT_ID}', 'aws', 'dev-account-003', 'dev-account-003', 'AmazonRDS', 'eu-west-1',
   'db-dev-abandoned', '{\"env\":\"dev\",\"team\":\"data\"}',
   89.10, 'USD', '$PERIOD_START', '$PERIOD_END',
   'DatabaseConnections', 0, 'Count',
   'Zero connections — likely abandoned', 'data', '$NOW'),

  ('${TENANT_ID}', 'aws', 'dev-account-003', 'dev-account-003', 'AWSLambda', 'eu-west-1',
   'dev-unused-email-sender', '{\"env\":\"dev\",\"team\":\"backend\"}',
   2.30, 'USD', '$PERIOD_START', '$PERIOD_END',
   'Invocations', 0, 'Count',
   'Zero invocations — likely unused', 'backend', '$NOW'),

  ('${TENANT_ID}', 'aws', 'dev-account-003', 'dev-account-003', 'AmazonVPC', 'eu-west-1',
   'eipalloc-dev00001', '{}',
   3.60, 'USD', '$PERIOD_START', '$PERIOD_END',
   'NetworkInterfaceAttachment', 0, 'Count',
   'Elastic IP not attached to any resource — incurring \$0.005/hour idle charge', 'unknown', '$NOW')
...
VALUES
  ...
  -- Active: healthy RDS
  ('${TENANT_ID}', 'aws', 'dev-account-002', 'dev-account-002', 'AmazonRDS', 'us-east-1',
