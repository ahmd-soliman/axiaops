...
func newMetrics() *Metrics {
	m := &Metrics{
		// HTTP metrics
		HTTPRequestsTotal: promauto.NewCounterWithRegistry(
		...
		HTTPRequestsDuration: promauto.NewHistogramWithRegistry(
		...
		HTTPRequestsInFlight: promauto.NewGaugeWithRegistry(
		...
		HTTPResponsesTotal: promauto.NewCounterVecWithRegistry(
			prometheus.CounterOpts{
		...
		HTTPErrorsTotal: promauto.NewCounterVecWithRegistry(
			prometheus.CounterOpts{
		...
		// Database metrics
		DBQueryDuration: promauto.NewHistogramVecWithRegistry(
			prometheus.HistogramOpts{
		...
		DBQueryErrors: promauto.NewCounterVecWithRegistry(
			prometheus.CounterOpts{
		...
		DBConnectionsActive: promauto.NewGaugeWithRegistry(
			prometheus.GaugeOpts{
		...
		DBTransactionDuration: promauto.NewHistogramVecWithRegistry(
			prometheus.HistogramOpts{
		...
		// AWS/Ingestion metrics
		AWSAPICallDuration: promauto.NewHistogramVecWithRegistry(
			prometheus.HistogramOpts{
		...
		AWSAPICallErrors: promauto.NewCounterVecWithRegistry(
			prometheus.CounterOpts{
		...
		CostRecordsFetched: promauto.NewCounterVecWithRegistry(
			prometheus.CounterOpts{
		...
		ResourcesAnalyzed: promauto.NewCounterWithRegistry(
			prometheus.CounterOpts{
		...
		GhostsDetected: promauto.NewGaugeVecWithRegistry(
			prometheus.GaugeOpts{
		...
		PotentialMonthlySaving: promauto.NewGaugeVecWithRegistry(
			prometheus.GaugeOpts{
		...
		// Scan lifecycle metrics
		ScanDuration: promauto.NewHistogramVecWithRegistry(
			prometheus.HistogramOpts{
		...
		ScanErrors: promauto.NewCounterVecWithRegistry(
			prometheus.CounterOpts{
		...
		ScanQueueDepth: promauto.NewGaugeWithRegistry(
			prometheus.GaugeOpts{
		...
		AccountsScanning: promauto.NewGaugeWithRegistry(
			prometheus.GaugeOpts{
		...
		// Application metrics
		ApplicationUptime: promauto.NewGaugeWithRegistry(
			prometheus.GaugeOpts{
		...
		ApplicationErrors: promauto.NewCounterWithRegistry(
			prometheus.CounterOpts{
	...
	// Register the custom registry with Prometheus if needed
	// This allows the metrics to be scraped via /metrics endpoint
	return m
}
