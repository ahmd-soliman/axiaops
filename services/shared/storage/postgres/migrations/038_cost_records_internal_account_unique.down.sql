-- 038_cost_records_internal_account_unique.down.sql
-- Revert: drop the internal_account_id-aware unique constraint and restore
-- the prior (organization_id, provider, account_id, service, region,
...
ALTER TABLE cost_records ALTER COLUMN internal_account_id DROP DEFAULT;
