...
hero:
  ...
  actions:
    - text: How it works
      link: /axiaops/guides/architecture/
      icon: right-arrow
    - text: Deploy it
      link: /axiaops/guides/deployment/
      icon: rocket
      variant: minimal
---
...
are still running, still billing, and doing nothing useful. An RDS instance
with zero connections. An EKS cluster with zero nodes, still billing its
control plane. A CloudWatch log group with no retention policy, quietly
accumulating storage charges forever. An idle EC2 instance nobody remembered
to shut down.
...
<CardGrid>
	...
	<Card title="Self-hostable" icon="open-book">
		...
		the bundled Valkey/Postgres for local evaluation — see
...
![Resources view listing zombie resources with cost and reason](../../assets/screenshots/resources-1.png)

### Trends — waste over time

![Trends view charting savings and scan history](../../assets/screenshots/trends.png)

### Costs — spend by service

![Costs view breaking down AWS spend by service](../../assets/screenshots/costs.png)
